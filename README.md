...
It can have parameters inside the config file that reference files.
The config file together with the referenced files can be downloaded or uploaded as a zip archive.
